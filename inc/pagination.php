...
if ( ! function_exists( 'almustawa_pagination' ) ) {
	/**
	 ...
	 */
	function almustawa_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'almustawa' ),
				'next_text'          => __( '&raquo;', 'almustawa' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'almustawa' ),
			)
		);
