[![Build Status](https://api.travis-ci.org/almustawa/almustawa.svg?branch=master)](https://travis-ci.org/almustawa/almustawa)
[![Wordpress Theme Version](https://img.shields.io/wordpress/theme/v/almustawa.svg)](https://wordpress.org/themes/almustawa)
[![Wordpress Theme Active Installs](https://img.shields.io/wordpress/theme/installs/almustawa.svg)](https://wordpress.org/themes/almustawa/)
[![Github Last Commit](https://img.shields.io/github/last-commit/almustawa/almustawa)](https://github.com/almustawa/almustawa/commits/master)
[![License: GPL v2](https://img.shields.io/badge/License-GPL%20v2-blue.svg)](https://www.gnu.org/licenses/old-licenses/gpl-2.0)

#### See: [Official Demo](https://almustawa.com/almustawa) | Read: [Official Docs Page](https://almustawa.github.io/)

# UnderStrap WordPress Theme Framework

Website: [https://almustawa.com](https://almustawa.com)

Child Theme Project: [https://github.com/almustawa/almustawa-child](https://github.com/almustawa/almustawa-child)

OverStrap Child Themes: [https://almustawa.com/overstrap/](https://almustawa.com/overstrap/)
...
- [Child Theme](https://github.com/almustawa/almustawa-child) ready.
- Translation ready.
...
- The `/css/theme.css` and its minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
 ...
 @import "almustawa/almustawa"; // 3. Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
### Classic install
- Download the almustawa folder from GitHub or from [https://almustawa.com](https://almustawa.com)
- IMPORTANT: If you download it from GitHub make sure you rename the "almustawa-master.zip" file just to "almustawa.zip" or you might have problems using child themes!
