	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'almustawa' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'almustawa' ); ?></th>
			</tr>
		</thead>
		<tbody>
